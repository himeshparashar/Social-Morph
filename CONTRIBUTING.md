...
```bash
SOCIAL-MORPH/
├── .app/                  # All the typescript files
│   
├── components/            # Landing page and UI components of the project
│   
├── lib/                   # Some typescript files
│   
├── public/                # All the images for reference of the public
│     
├── utils/                 # React and javascript file
│   
├── .dockerignore         
│   
├── .env.example           
...
```bash
git clone https://github.com/<your-github-username>/Social-Morph.git
```
...
- Admin Github Profile :- [Himesh Parashar] (https://github.com/himeshparashar)
- Contact :- [Email](himeshparasharsh@protonmail.com)
...
1. Navigate to the project's issues section :- [Issues](https://github.com/himeshparashar/Social-Morph/issues)

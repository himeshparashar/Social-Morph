  ...
  return (
    <div className="w-[90%] mx-auto mt-36 mb-24">
      <div className="flex justify-between items-center">
        <div className="w-1/2 bg-gradient-to-r from-purple-50 to-purple-200 shadow-lg shadow-purple-400 rounded-2xl">
          <div className="px-10 py-7">
            <h1 className="text-5xl leading-[3.5rem] font-bold gradient-text w-3/4">
      ...
      <div className="flex justify-between items-center mt-14">
        ...
        <div className="w-1/2 bg-gradient-to-r to-purple-50 from-purple-200 shadow-lg shadow-purple-400 rounded-2xl">
          <div className="p-20">
            <h1 className="text-5xl leading-[3.5rem] font-bold gradient-text">

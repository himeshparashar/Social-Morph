  ...
  return (
    <div className="w-3/5 mx-auto">
      ...
      <div className="mt-20 text-center">
        ...
        />
        <button className="text-lg hover:bg-gradient-to-r hover:from-slate-600 hover:to-slate-800 text-white px-3 py-1 rounded-full bg-gradient-to-r from-purple-500 to-purple-900 hover:transition-all hover:duration-500 hover:shadow-md shadow-purple-400 shadow-md hover:shadow-gray-500 absolute -ml-28 mt-3">
          Get Posts
        </button>
      </div>
    </div>

...
import { CalendarDays, Lightbulb, BarChart3, Plus, Search, Edit3, LogOut, Menu, LayoutDashboard, FolderKanban, Briefcase } from "lucide-react";
  ...
  return (
    <div
      ...
      style={{
        ...
        `,
        backgroundSize: '40px 40px', // Set grid size
      }}
    >
      {/* Sidebar */}
      <aside className={`${isMinimized ? 'w-16' : 'w-64'} border-r bg-[#f8f9fa] shadow-lg flex flex-col transition-all duration-300`}>
        <div className="p-4 flex-grow">
          ...
          <nav className="space-y-1">
            {[
              ...
              >
                <span className={`flex-shrink-0 ${isMinimized ? 'mx-auto' : 'mr-3'}`}>{item.icon}</span>
